...
type CallRecord struct {
	...
	From      string     `gorm:"size:50;not null;index" json:"from"`
	To        string     `gorm:"size:50;not null;index" json:"to"`
	...
	FromExt string `gorm:"size:50;index" json:"from_ext"`
	ToExt   string `gorm:"size:50;index" json:"to_ext"`
