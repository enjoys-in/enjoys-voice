...
/* Floating action button */
.evw-fab{position:relative;width:60px;height:60px;border-radius:50%;border:none;cursor:pointer;color:#fff;background:linear-gradient(135deg,${color},color-mix(in srgb,${color} 65%,#000));box-shadow:0 10px 26px color-mix(in srgb,${color} 45%,transparent),0 2px 6px rgba(0,0,0,.2);display:flex;align-items:center;justify-content:center;align-self:flex-end;transition:transform .18s cubic-bezier(.34,1.56,.64,1),box-shadow .2s ease,background .2s ease}
